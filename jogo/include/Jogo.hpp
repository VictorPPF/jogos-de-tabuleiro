...
public:
    // Construtor
    Jogo(Jogador* jogador1, Jogador* jogador2) : player1(jogador1), player2(jogador2), status(0), jogador_atual(player1->getApelido()) {}
    Jogo():player1(nullptr), player2(nullptr),status(-1), jogador_atual("-1"){};
